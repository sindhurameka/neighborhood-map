  ...
  // The searchTerms array consists of search terms for different categories of places
	...
	for (var i = 0; i < len ; i++) {
			...
			//Yelp Data related to each serachTerm(category) is got using the fuction getYelpData()
		...
		showMeTheMarker = function()
		{
			...
			for (var i = 0; i < markers.length; i++) {
				...
				if(markerLat == locationLat) {
					...
					var marker = new google.maps.Marker({ position: location, map: markers[i].get('map') });
